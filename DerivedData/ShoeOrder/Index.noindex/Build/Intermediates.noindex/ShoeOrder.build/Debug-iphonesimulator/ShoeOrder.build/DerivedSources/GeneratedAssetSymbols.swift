...
extension ImageResource {
    ...
    static let bill = ImageResource(name: "bill", bundle: resourceBundle)
    ...
    static let customer = ImageResource(name: "customer", bundle: resourceBundle)
    ...
    static let orderList = ImageResource(name: "orderList", bundle: resourceBundle)

    /// The "passw" asset catalog image resource.
    static let passw = ImageResource(name: "passw", bundle: resourceBundle)
    ...
    static let user = ImageResource(name: "user", bundle: resourceBundle)
